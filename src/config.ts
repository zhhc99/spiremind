...
export const UI_STRINGS = {
  zh: {
    ...
    deleteTier: '删除 Tier',
    sortTier: '自动排序',
    tierTitlePlaceholder: '给这份 Tier List 起个标题',
    unclassified: '卡池',
    search: '按 Tab 搜索卡牌...',
    searchCompact: '搜索...',
    note: '注释',
    ...
    betaChannel: 'Beta',
    cardCategories: '卡牌类别',
    includeMultiplayer: '多人牌',
    includeColorless: '无色牌',
  ...
  en: {
    ...
    sortTier: 'Auto sort',
    tierTitlePlaceholder: 'Name this tier list',
    ...
    includeMultiplayer: 'Multiplayer Cards',
    includeColorless: 'Colorless Cards',
